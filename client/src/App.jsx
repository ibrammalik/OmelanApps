  ...
  return (
    <>
      <Routes>
        ...
        {/* caretaker */}
        <Route
          element={<PrivateDashboard allowedRole="caretaker" redirectTo="/dashboard/caregiver/" />}>
          <Route path={ROUTES.caretaker.dashboard} element={<Dashboard />}>
            ...
            <Route path={ROUTES.caretaker.appointment} element={<UserAppointment />} />
            <Route path={ROUTES.caretaker.order} element={<CaregiverAppointment />} />
            <Route path={ROUTES.caretaker.favorite} element={<FavoriteCaregiver />} />
            <Route path={ROUTES.caretaker.review} element={<AppointmentSummary />} />
          </Route>
        </Route>

        {/* caregiver */}
        <Route element={<PrivateDashboard allowedRole="caregiver" redirectTo="/pesan" />}>
        ...
        /> */}
            <Route path={ROUTES.caregiver.appointment} element={<CaregiverAppointment />} />
